...
A structured SQL-based Exploratory Data Analysis (EDA) project built on a retail sales database (Gold layer). The project progresses from foundational data exploration through to advanced analytics and production-ready business reports.
